...
public class RedisRepositoryImpl implements RedisRepository {
    ...
    public void save(Item item) { 
    	...
    	avalue.put(item.getCode(), item.getName());
	...
	public JsonNode getAllForKey(String key, AggregateRequestDto request, ObjectNode chartNode) {
		try {
			...
			if (request.getFilters() != null) {
				applyFilters(avalue, key, request, requestQueryMap);
			}
	...
	public Map<String, String> applyFilters(Map<String, String> avalue, String key, AggregateRequestDto request, Map<String, Map<String, String>> requestQueryMap) {
