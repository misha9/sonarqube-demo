 ...
 */
@Component
public class PieChartDruidResponseHandler implements IResponseHandler {
    public static final Logger logger = LoggerFactory.getLogger(PieChartDruidResponseHandler.class);
